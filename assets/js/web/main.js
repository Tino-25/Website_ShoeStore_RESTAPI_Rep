...
$(document).ready(function(){
	...
	document.querySelector('.showresponsive_headertop').onclick = function(){
		if(document.querySelector('.header-top').getAttribute('style') == 'display: block !important;'){
			document.querySelector('.header-top').setAttribute('style', 'display: none !important;')
		}else{
			document.querySelector('.header-top').setAttribute('style', 'display: block !important;')
		}
